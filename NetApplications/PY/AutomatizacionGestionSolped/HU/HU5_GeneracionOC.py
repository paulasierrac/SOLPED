...
from Funciones.ValidacionM21N import boton_existe, buscar_y_clickear, ejecutar_accion_sap
...
def GenerarOCDesdeSolped(session, solped,item=2):
    try:
      ...
      ejecutar_accion_sap(id_documento="click Solicitud de pedidos ",ruta_vbs=rf".\scriptsVbs\clickptclickSolicituddepedidos.vbs")  
      ...
      for i in range(item):
        ...
        print(f"Navegando por la posicion {i+1} de la Solped {solped} Esperando foco en pestana textos..")
        ejecutar_accion_sap(id_documento="click pestana texto e info ",ruta_vbs=rf".\scriptsVbs\clickptextos.vbs")  
        ...
        ejecutar_accion_sap(id_documento="boton abajo",ruta_vbs=rf".\scriptsVbs\clickbotonabajo.vbs")
        time.sleep(1)
